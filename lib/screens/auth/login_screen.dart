...
class _LoginScreenState extends State<LoginScreen> {
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    keyboardType: TextInputType.emailAddress,
                    validator: ValidateLogin.emailValidate,
                    style: const TextStyle(fontFamily: 'WorkSansSemiBold', fontSize: 16.0), // Set text color to orange
                    decoration: InputDecoration(
                      filled: true, // Added to enable background color
                      ...
                      prefixIcon: Icon(
                        Icons.email,
                        color: Colors.blue, // Set icon color to orange
                        size: 22.0,
                      ),
                      hintText: 'Email Address',
                      hintStyle: TextStyle(fontFamily: 'WorkSansSemiBold', fontSize: 17.0),
  ...
  obscureText: _obscureTextPassword,
  validator: ValidateLogin.password,
  style: const TextStyle(fontFamily: 'WorkSansSemiBold', fontSize: 16.0, color: Colors.orange), // Set text color to orange
  decoration: InputDecoration(
    filled: true, // Added to enable background color
    ...
    prefixIcon: const Icon(
      Icons.lock,
      size: 22.0, // Set icon color to orange
    ),
    hintText: 'Password',
    hintStyle: const TextStyle(fontFamily: 'WorkSansSemiBold', fontSize: 17.0),
    suffixIcon: GestureDetector(
                      ...
                      style: ButtonStyle(
                        shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                          RoundedRectangleBorder(
                            ...
                            side: BorderSide(), // Set border color to orange
                          ),
                        ),
                        padding: MaterialStateProperty.all<EdgeInsets>(EdgeInsets.symmetric(vertical: 20)),
                        backgroundColor: MaterialStateProperty.all<Color>(Colors.green), // Set button background color to orange
                      ),
                      onPressed: () {
                        login();
                      },
